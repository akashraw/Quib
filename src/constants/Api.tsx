...
export const RegisterAPI = `${API}api/User/Register`;
export const image256API = `${API}Images/User256/`;
export const isUserFollowedAPI = `${API}api/Community/isUserFollowed`;
