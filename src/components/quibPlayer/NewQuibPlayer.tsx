...
export default function NewQuibPlayer({ navigation, route }: props) {
            ...
            <BottomSheetModalProvider>
                <SafeAreaView
                    style={{
                        ...
                        <View
                                ...
                                <Slider
                                    ...
                                    thumbStyle={{ width: vw(3), height: vw(3) }}
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={{ height: vh(85), width: vw(100), flex:1 }}>
