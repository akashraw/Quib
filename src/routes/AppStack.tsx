...
import { BackIcon, EditIcon, Heading, Logo } from '../components/HeaderComponents';
...
export default function AppStack() {
    console.log('hi');
    return (
        <Stack.Navigator screenOptions={{ headerStyle: { backgroundColor: Style.quibHeader }, statusBarColor: Style.quibHeader }} initialRouteName="Bottom">
